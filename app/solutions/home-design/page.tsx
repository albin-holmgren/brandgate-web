    ...
    <div className="bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-200">
      ...
      <div className="p-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="col-span-2 bg-white rounded-lg p-3 shadow-sm">
              <div className="h-16 bg-gray-100 rounded flex items-center justify-center mb-2">
                <Layers className="w-8 h-8 text-[#E5A400]" />
              </div>
            ...
            <div className="bg-white rounded-lg p-3 shadow-sm">
              <div className="h-16 bg-gray-100 rounded flex items-center justify-center mb-2">
                <Box className="w-6 h-6 text-[#E5A400]" />
              </div>
            ...
            <div className="bg-white rounded-lg p-3 shadow-sm">
              <div className="h-12 bg-gray-100 rounded flex items-center justify-center mb-2">
                <Package className="w-6 h-6 text-[#E5A400]" />
              </div>
            ...
            <div className="col-span-2 bg-white rounded-lg p-3 shadow-sm">
              <div className="h-12 bg-gray-100 rounded flex items-center justify-center mb-2">
                <Maximize className="w-8 h-8 text-[#E5A400]" />
              </div>
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="font-bold text-[#003822]">€1,796</span>
        </div>
      </div>
    </div>
  );
    ...
    <div className="bg-white rounded-xl shadow-xl p-4 border border-gray-200">
      <div className="flex items-center justify-between mb-4">
        <span className="text-sm font-semibold text-gray-900 flex items-center gap-2">
          <Truck className="w-4 h-4 text-[#E5A400]" />
          Freight Calculator
        </span>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 border border-amber-200 p-3 rounded-lg">
          <div className="flex items-center justify-between">
            ...
            <p className="text-2xl font-bold text-[#E5A400]">€127</p>
          </div>
        </div>

        <div className="flex items-center gap-2 text-xs text-gray-600">
          <CheckCircle2 className="w-4 h-4 text-[#003822]" />
      ...
      <main>
              ...
              <div>
                <FadeIn>
                  ...
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold uppercase leading-tight">
                    Room-Perfect
                    <span className="text-[#E5A400] block">Collections</span>
                  </h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeIn>
              <div className="text-center max-w-2xl mx-auto mb-16">
                <span className="text-[#E5A400] font-semibold text-sm uppercase">Built for Furniture</span>
            ...
            <div className="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Room Collections */}
              <FadeIn>
                <div className="bg-gray-50 rounded-2xl p-8 border border-amber-100 flex flex-col h-full">
                  ...
                  <div className="mt-4 pt-4 border-t border-amber-200">
                    <span className="text-sm text-[#E5A400] font-medium">12 room templates included</span>
                  </div>
                </div>
              </FadeIn>
              ...
              <FadeIn delay={0.1}>
                <div className="bg-gray-50 rounded-2xl p-8 border border-amber-100 flex flex-col h-full">
                  ...
                  <div className="mt-4 pt-4 border-t border-amber-200">
                    <span className="text-sm text-[#E5A400] font-medium">Unlimited variants</span>
                  </div>
                </div>
              </FadeIn>
              ...
              <FadeIn delay={0.2}>
                <div className="bg-gray-50 rounded-2xl p-8 border border-amber-100 flex flex-col h-full">
                  ...
                  <div className="mt-4 pt-4 border-t border-amber-200">
                    <span className="text-sm text-[#E5A400] font-medium">PDF & video support</span>
                  </div>
                </div>
              </FadeIn>
              ...
              {/* Freight Management */}
              <FadeIn delay={0.3}>
                <div className="bg-gray-50 rounded-2xl p-8 border border-orange-100 flex flex-col h-full">
                  <div className="w-14 h-14 bg-gray-500 rounded-xl flex items-center justify-center mb-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-orange-200">
                    <span className="text-sm text-[#003822] font-medium">Real-time freight quotes</span>
                  </div>
                </div>
              </FadeIn>
              ...
              <FadeIn delay={0.4}>
                <div className="bg-gray-50 rounded-2xl p-8 border border-orange-100 flex flex-col h-full">
                  <div className="w-14 h-14 bg-[#E5A400] rounded-xl flex items-center justify-center mb-6">
                  ...
                  <div className="mt-4 pt-4 border-t border-orange-200">
                    <span className="text-sm text-[#003822] font-medium">Smart calculations</span>
                  </div>
                </div>
              </FadeIn>
              ...
              <FadeIn delay={0.5}>
                <div className="bg-gray-50 rounded-2xl p-8 border border-orange-100 flex flex-col h-full">
                  ...
                  <div className="mt-4 pt-4 border-t border-orange-200">
                    <span className="text-sm text-[#003822] font-medium">Swatch tracking</span>
                  </div>
                </div>
              </FadeIn>
            </div>
        ...
        <section className="py-20 bg-[#003822] text-white text-center">
          <div className="max-w-3xl mx-auto px-4">
            <Home className="w-12 h-12 text-[#E5A400] mx-auto mb-6" />
