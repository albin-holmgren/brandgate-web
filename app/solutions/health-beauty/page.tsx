      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          <div className="bg-green-50 border border-green-200 rounded-lg p-2 text-center">
            ...
            <p className="text-xs font-medium text-green-700">Vegan</p>
          </div>
          <div className="bg-pink-50 border border-pink-200 rounded-lg p-2 text-center">
            <Sparkles className="w-4 h-4 text-pink-600 mx-auto mb-1" />
            <p className="text-xs font-medium text-pink-700">Cruelty-Free</p>
          </div>
        </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-3 bg-gray-50 p-3 rounded-lg">
          ...
          <div className="text-right">
            <p className="text-xs font-semibold text-green-600">COA ✓</p>
            <p className="text-xs text-gray-500">Expires 2028</p>
          </div>
        </div>

        <div className="bg-pink-50 rounded-lg p-3">
          <p className="text-xs font-medium text-pink-800 mb-2">Quality Documents</p>
  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="bg-pink-600 text-white py-20 lg:py-32">
              ...
              <div>
                <FadeIn>
                  ...
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold uppercase leading-tight">
                    Beauty
                    <span className="text-pink-200 block">Without Risk</span>
                  </h1>
                  ...
                  <div className="flex flex-wrap gap-4 mt-8">
                    <Button className="bg-white text-pink-600 hover:bg-gray-100 rounded-full px-8 font-semibold">
        ...
        {/* COMPLIANCE BADGES */}
        <section className="py-6 bg-pink-50 border-y border-pink-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              {['EU Cosmetics Regulation', 'FDA Compliant', 'GMP Certified', 'ISO 22716'].map((badge) => (
                <span key={badge} className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm text-pink-700">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeIn>
              <div className="text-center max-w-2xl mx-auto mb-16">
                <span className="text-pink-600 font-semibold text-sm uppercase">Compliance Features</span>
              ...
              <div className="lg:col-span-2 bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-8 border border-pink-100">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="bg-white p-3 rounded-lg text-center">
                    <p className="text-lg font-bold text-pink-600">INCI</p>
                    <p className="text-xs text-gray-500">Standard Format</p>
                  </div>
                  <div className="bg-white p-3 rounded-lg text-center">
                    <p className="text-lg font-bold text-pink-600"> allergens</p>
                    <p className="text-xs text-gray-500">Auto-Detected</p>
                  </div>
                  <div className="bg-white p-3 rounded-lg text-center">
                    <p className="text-lg font-bold text-pink-600">26</p>
        ...
        <section className="py-20 bg-pink-600 text-white text-center">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <Button className="bg-white text-pink-600 hover:bg-gray-100 rounded-full px-10 py-6 text-lg font-semibold">
